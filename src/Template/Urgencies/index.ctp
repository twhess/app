 ...
 * @var \App\Model\Entity\Urgency[]|\Cake\Collection\CollectionInterface $urgencies
 */
?>
...
<div class="urgencies index large-9 medium-8 columns content">
    <h3><?= __('Urgencies') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $urgency->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $urgency->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $urgency->id], ['confirm' => __('Are you sure you want to delete # {0}?', $urgency->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
